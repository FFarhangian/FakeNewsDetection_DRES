...
from deslib2.base import BaseDS
from deslib2.util.aggregation import (aggregate_proba_ensemble_weighted,
                                     sum_votes_per_class,
                                     get_weighted_votes)
...
class BaseDES(BaseDS):
    ...
    def __init__(self, pool_classifiers=None, k=7, DFP=False, with_IH=False,
                 ...
                 DSEL_perc=0.5, n_jobs=-1, alg_pool=None):
        ...
        super(BaseDES, self).__init__(pool_classifiers=pool_classifiers,
                                      ...
                                      knne=knne,
                                      DSEL_perc=DSEL_perc, n_jobs=n_jobs, alg_pool=alg_pool)
        self.mode = mode
        self.voting = voting
